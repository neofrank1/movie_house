...
export function AppHeader() {
    ...
    const handleSearch = async (e: FormEvent<HTMLFormElement>) => {
        ...
        const searchMovieQuery = { s: formData.get("searchTitle") as string || "" };
                ...
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-lg gap-4">
                    ...
                    <form onSubmit={handleSearch} className="flex-1 max-w-2xl">
                        <div className="flex justify-end items-center gap-2 w-full">
                            <Input name="searchTitle" placeholder="Search for a movie" className="w-full max-w-md mx-1 my-1 bg-white" onKeyDown={handleKeyDown} />
